...
public class AdminPatientActivity extends AppCompatActivity{
    ...
    private void createPatient(String pesel, String lastName, String firstName, String address, String phoneNumber) {
        ...
        RequestService.createPatient(AdminPatientActivity.this, pesel, lastName, firstName, address, phoneNumber);
    }

    private void updatePatient(String pesel, String name, String firstname, String address, String phoneNumber, Integer patientId) {
        RequestService.editPatient(AdminPatientActivity.this, pesel, name, firstname, address, phoneNumber, patientId);
    ...
    public void showPatientEditDialog(final boolean shouldUpdate, final Patient patient, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(AdminPatientActivity.this);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(inputPesel.getText().toString()) ||
                    ...
                    Toast.makeText(AdminPatientActivity.this,
